...
insert into test_types (name) VALUE ('Rupture dvp.Test : FBruch  : [N]');
insert into test_types (name) VALUE ('Rupture dvp.Test : Position R Position RC Position M : [%]');
insert into test_types (name) VALUE ('Rupture dvp.Test');
insert into test_types (name) VALUE ('Water Vapor dvp.Test : FBruch  : [kN]');
insert into test_types (name) VALUE ('Water Vapor dvp.Test : Position R Position RC Position M : [%]');
insert into test_types (name) VALUE ('Water Vapor dvp.Test');
insert into test_types (name) VALUE ('Salt Spray dvp.Test : Internally');
insert into test_types (name) VALUE ('Salt Spray dvp.Test : FBruch  : [kN]');
insert into test_types (name) VALUE ('Salt Spray dvp.Test : Position R Position RC Position M : [%]');
insert into test_types (name) VALUE ('Salt Spray dvp.Test');
insert into test_types (name) VALUE ('Endurance Strength dvp.Test : Inner Part : [mm]');
insert into test_types (name) VALUE ('Endurance Strength dvp.Test : Outer Part : [mm]');
insert into test_types (name) VALUE ('Endurance Strength dvp.Test');
