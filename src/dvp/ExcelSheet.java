...
/**
 * Class that contains all tests of one Excel DVP file, with functions to generate dvp.TestWrapper instances
...
public class ExcelSheet {
    ...
    /**
     * Generate instances of dvp.TestWrapper for each and every test in the listOfAllTests
     *
     * @return the list of new instances of dvp.TestWrapper
     */
    ...
    /**
     * Uses parser.DVPParser to get all tests from the given Excel file and saves them in listOfAllTests
     *
