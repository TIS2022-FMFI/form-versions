...
import finders.TemplateFinder;
import finders.TestTypeFinder;
...
/**
 * Class for storing information about a dvp.Template
 *
...
public class Template {
    ...
    public List<String> result_names = new ArrayList<>();
    public List<Integer> row_ids = new ArrayList<>();
    public List<Integer> col_ids = new ArrayList<>();
    public List<Integer> sheet_ids = new ArrayList<>();
     ...
     *
     * @param testWrapperList list of given dvp.TestWrapper instances
     */
