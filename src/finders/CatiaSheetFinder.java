...
/**
 * Class for finding instances of catia.CatiaSheet stored in the database
 *
...
public class CatiaSheetFinder {
    ...
    /**
     * Find a catia.CatiaSheet instance with given ID stored in the database and return it as a list of catia.CatiaSheet instances
     *
     * @param id the id of a part we want to search for
     * @return the list of all catia.CatiaSheet as instances of catia.CatiaSheet
    ...
    /**
     * Find all catia.CatiaSheet instances with given base ID stored in the database and return it as a list of catia.CatiaSheet instances
     *
