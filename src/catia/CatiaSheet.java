...
/**
 * Class for storing a catia.CatiaSheet pdf
 *
...
public class CatiaSheet {
    ...
    /**
     * Parses the lines from the PDF from parser.PDFParser and creates instasnces of catia.BOM, catia.CatiaComment and other in the main
     * catia.CatiaSheet instance
     *
    ...
    /**
     * @return the latest (newest) catia.CatiaComment instance
     */
