...
import finders.DatabaseChangeFinder;
...
public class DbLogController implements Initializable {
    ...
    public void fillListView() throws SQLException {
        ...
        if (!Objects.equals(changesOfThisUserTextField.getText(), "")){
            ...
            user.forEach(i -> {
                tempString.append("backend.User ").append(i.getWorkerId()).append(" ").append(i.getChange()).append(" at ").append(i.getTimestamp());
            ...
            StringBuilder tempString = new StringBuilder();
            temp.forEach(i -> {
                tempString.append("backend.User ").append(i.getWorkerId()).append(" ").append(i.getChange()).append(" at this timestamp : ").append(i.getTimestamp());
                items.add(tempString.toString());
                tempString.setLength(0);
            });
        }
