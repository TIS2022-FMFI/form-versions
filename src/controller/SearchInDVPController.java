...
public class SearchInDVPController implements Initializable {
    ...
    /**
     * Fill the global variable testsForCurrentSearch with all available instances of dvp.Test
     *
    ...
    /**
     * Generate dvp.TestWrapper instances for all tests available in the current selection for the frontend
     * @return list of dvp.TestWrapper instances
     */
